...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mets:dmdSec">
        ...
        <xsl:result-document method="text" href="ordered2/{$Jahr}_{$filenamepro}{$ORDBEGINN}.txt">
            ...
            <xsl:for-each select="/mets:mets/mets:structLink/mets:smLink[@xlink:from=$IDlog]/@xlink:to">
                ...
                <xsl:variable name="fin2">
                    ...
                    <xsl:value-of select="concat('/home/leonard/Desktop/TopicModelling/Daten/new/',$processed,'.xml')"/>
                </xsl:variable>
                
                <xsl:copy-of select="document($fin2)"/>
